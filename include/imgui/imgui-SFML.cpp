...
#pragma GCC diagnostic pop
               ...
               const sf::Color &tintColor, const sf::Color &borderColor)
    {
        ...
        ImGui::Image(textureID, ImVec2(texture.getSize().x / scaleFactor, texture.getSize().y / scaleFactor),
                     ImVec2(0, 1), ImVec2(1, 0), toImColor(tintColor), toImColor(borderColor));
    }
